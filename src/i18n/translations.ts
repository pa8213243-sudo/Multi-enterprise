...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    products: {
      ...
      subtitle: 'Manufactured with high-grade durable PVC compounds, DOP/DEHP-free options, suited for heavy industry, food safety, and cold chain environments.',
  ...
  hi: {
    ...
    hero: {
      ...
      statQualityLabel: 'सामग्री गुणवत्ता',
      statQualityVal: 'उत्कृष्ट गुणवत्ता',
    ...
    products: {
      ...
      subtitle: 'उच्च गुणवत्ता वाली टिकाऊ पीवीसी सामग्री से निर्मित, हेवी इंडस्ट्री, फूड सेफ्टी और कोल्ड चेन के लिए उपयुक्त।',
